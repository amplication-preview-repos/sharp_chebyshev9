...
@InputType()
class TransactionsCreateNestedManyWithoutPropertiesItemsInput {
...
export { TransactionsCreateNestedManyWithoutPropertiesItemsInput as TransactionsCreateNestedManyWithoutPropertiesItemsInput };
